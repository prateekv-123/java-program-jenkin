...
public class Test_Cases {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        // driver.findElement(By.xpath("//a[@href='https://practicetestautomation.com/courses/']")).click();
         //driver.findElement(By.xpath("//a[@href='https://practicetestautomation.com/beginners-course-coupon']")).click();
        // driver.findElement(By.xpath("//button[@class='ud-btn ud-btn-large ud-btn-primary ud-heading-md add-to-cart']")).click();
